                        ...
                        <div class="rounded shadow p-3 bg-body">
                            ...
                            <table class="table text-center default-cursor">
                                ...
                                <tbody>
                                    ...
                                    <td>${C.value.plant.price}VNĐ</td>
                                    <td>${C.value.quantity}</td>
                                    <td>${C.value.plant.price * C.value.quantity}VNĐ</td>
                                    <c:set var="total" scope="request" value="${total + C.value.plant.price * C.value.quantity}"/>
                                    </tr>
                                </c:forEach>
                                </tbody>
                            </table>
                            <h3 class="text-end default-cursor text-black">Total Amount: <span style="color: red;">${not empty totalMoney ? totalMoney : total}VNĐ</span></h3>
                        </div>
                    </div>
