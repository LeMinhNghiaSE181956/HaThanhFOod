...
<html lang="en">
  ...
  <div id="search-nav" class="d-flex align-items-center">
    <div class="container text-center">
        <span class="body">
            <a class="home-page text-decoration-none" href="HomeController">Home page</a>
            <span class="open-icon txt-m-bold"><i class="bi bi-caret-right-fill"></i></span>
            <span class="txt-m-bold txt-orange default-cursor">All products</span>
        </span>
    </div>
</div>
        ...
        <div class="container mb-5">
            <div class="row">
                <div class="col-md-3">
                    <h3 class="mb-4 default-cursor text-black">Danh Mục</h3>
                                            ...
                                            <div class="card-body p-2">
                                                <div class="text-center product-info">
                                                    ...
                                                    <div class="price text-center fs-4 fw-bold default-cursor text-black">
                                                        <span class="text-muted text-decoration-line-through">${LP.price + 70000}VNĐ</span>
                                                        ${LP.price}VNĐ
                                                    </div>
                                                </div>
                                            </div>
